...
#img = Path("//klient.uib.no/FELLES/LAB-IT/IFT/Resfys/medium_FF_AB_data/AB_image_sets/AC04/211021_time125319_DSC15716.JPG")
img = list(sorted(Path("/home/jakub/images/ift/medium/albus/AC04").glob("*")))[0]
