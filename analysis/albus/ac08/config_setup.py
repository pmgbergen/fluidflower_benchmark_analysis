...
#img = Path("//klient.uib.no/FELLES/LAB-IT/IFT/Resfys/medium_FF_AB_data/AB_image_sets/AC08/220421_time140217_DSC11082.JPG")
img = list(sorted(Path("/media/jakub/Elements/Jakub/benchmark/data/albus/AC08").glob("*")))[0]
