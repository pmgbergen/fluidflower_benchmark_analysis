...
#img = Path("//klient.uib.no/FELLES/LAB-IT/IFT/Resfys/medium_FF_AB_data/AB_image_sets/AC03/211018_time125419_DSC11052.JPG")
img = list(sorted(Path("/home/jakub/images/ift/medium/albus/AC03").glob("*")))[0]
