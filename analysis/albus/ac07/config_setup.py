...
#img = Path("//klient.uib.no/FELLES/LAB-IT/IFT/Resfys/medium_FF_AB_data/AB_image_sets/AC07/211208_time152544_DSC00254.JPG")
img = list(sorted(Path("/home/jakub/images/ift/medium/albus/AC07").glob("*")))[0]
