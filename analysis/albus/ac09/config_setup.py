...
#img = Path("//klient.uib.no/FELLES/LAB-IT/IFT/Resfys/medium_FF_AB_data/AB_image_sets/AC09/220503_time122716_DSC14714.JPG")
img = list(sorted(Path("/media/jakub/Elements/Jakub/benchmark/data/albus/AC09").glob("*")))[0]
