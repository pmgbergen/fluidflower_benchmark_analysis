...
#img = Path("//klient.uib.no/FELLES/LAB-IT/IFT/Resfys/medium_FF_AB_data/AC14_Pictures_with_time/AC14_inj_220610_092900_30s/220610_time112806_DSC28507.JPG")
img = list(sorted(Path("/media/jakub/Elements/Jakub/benchmark/data/albus/AC14").glob("*")))[0]
