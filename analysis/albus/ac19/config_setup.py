...
#img = Path("//klient.uib.no/FELLES/LAB-IT/IFT/Resfys/medium_FF_AB_data/AB_image_sets/AC10/220506_time161354_DSC17526.JPG")
img = list(sorted(Path("/media/jakub/Elements/Jakub/benchmark/data/albus/AC19").glob("*")))[0]
