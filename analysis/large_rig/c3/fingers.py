"""
Post analysis script analyzing the evolution of fingers in C3.
"""
...
base = Path("/media/jakub/Elements/Jakub/benchmark/data/large_rig/c3/211214_time112000_DSC01547.TIF")
...
start_index = 0
end_index = 127
originals = Path("/media/jakub/Elements/Jakub/benchmark/data/large_rig/c3").glob("*")
originals = list(sorted(originals))[baseline_offset:]

segmentations = Path("/media/jakub/Elements/Jakub/benchmark/results/large_rig/fixed-thresholds/c3/npy_segmentation").glob("*.npy")
