"""
Post analysis script analyzing the evolution of fingers in C2.
"""
...
base = Path("/media/jakub/Elements/Jakub/benchmark/data/large_rig/c2/211204_time100100_DSC04909.TIF")
...
start_index = 0
end_index = 127
originals = Path("/media/jakub/Elements/Jakub/benchmark/data/large_rig/c2").glob("*")
originals = list(sorted(originals))[baseline_offset:]

segmentations = Path("/media/jakub/Elements/Jakub/benchmark/results/large_rig/fixed-thresholds/c2/npy_segmentation").glob("*.npy")
