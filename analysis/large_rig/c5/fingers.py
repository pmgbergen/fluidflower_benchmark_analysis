"""
Post analysis script analyzing the evolution of fingers in C5.
"""
...
base = Path("/media/jakub/Elements/Jakub/benchmark/data/large_rig/c5/220104_time110000_DSC13529.TIF")
...
start_index = 0
end_index = 127
originals = Path("/media/jakub/Elements/Jakub/benchmark/data/large_rig/c5").glob("*")
originals = list(sorted(originals))[baseline_offset:]

segmentations = Path("/media/jakub/Elements/Jakub/benchmark/results/large_rig/fixed-thresholds/c5/npy_segmentation").glob("*.npy")
