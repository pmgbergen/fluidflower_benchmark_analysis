"""
Post analysis script analyzing the evolution of fingers in C4.
"""
...
base = Path("/media/jakub/Elements/Jakub/benchmark/data/large_rig/c4/211224_time090000_DSC07180.TIF")
...
start_index = 0
end_index = 127
originals = Path("/media/jakub/Elements/Jakub/benchmark/data/large_rig/c4").glob("*")
originals = list(sorted(originals))[baseline_offset:]

segmentations = Path("/media/jakub/Elements/Jakub/benchmark/results/large_rig/fixed-thresholds/c4/npy_segmentation").glob("*.npy")
